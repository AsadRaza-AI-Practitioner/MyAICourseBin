...
import numpy as np
import numpy as np
ids, price , long , lat = np.genfromtxt('zameencom-property-data-By-Kaggle-short.csv', delimiter=';', usecols=(0,4,8,9), unpack=True, dtype=None,skip_header=1)
...
print("Zameen.com Price average: " , np.average(lat))
